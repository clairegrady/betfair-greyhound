...
# Configuration
POSITION_TO_LAY = 15  # Laying the FAVORITE
MAX_ODDS = 500
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(f'/Users/clairegrady/RiderProjects/betfair/horse-racing-predictor/lay_betting/lay_position_{POSITION_TO_LAY}.log'),
