#!/usr/bin/env python3
"""
Backfill BSP for already-settled horse bets that don't have BSP populated.
...
def backfill_bsp():
    ...
    cursor.execute("""
        SELECT id, market_id, selection_id, horse_name, date
        FROM paper_trades
    ...
    for bet_id, market_id, selection_id, horse_name, date in bets:
