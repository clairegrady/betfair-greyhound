...
runner_chunks_path = Path("/Users/clairegrady/RiderProjects/betfair/afl-model/historical-data/processed/runner_level_chunks")
greyhound_file = Path("/Users/clairegrady/RiderProjects/betfair/afl-model/historical-data/processed/selected_afl_features.parquet")
merged_chunks_path = Path("/Users/clairegrady/RiderProjects/betfair/afl-model/historical-data/processed/merged_chunks")
merged_chunks_path.mkdir(parents=True, exist_ok=True)

# Load Greyhound feature data once
greyhound_df = pd.read_parquet(greyhound_file, engine='fastparquet')
